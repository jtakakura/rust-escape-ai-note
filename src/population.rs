...
use crate::{
    agent::AgentCommand, editor::Editor, ff::FF, game::Game, FRAME_SCALE, NUM_GAMES,
    NUM_GAMES_IN_ROW, POP_EXPO_PERCENTAGE, POP_RETENTION_RATE, RESOURCES, UNIT_FRAME_SIZE,
};
...
impl Population {
    ...
    pub fn selection(&mut self) {
        ...
        // Exploration agents
        let mut exploration_agents: Vec<Game> =
            (0..num_expo as usize).map(|_| Game::new()).collect();
